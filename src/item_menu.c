...
static const u16 sItemsByType[ITEMS_COUNT] =
{
    ...
    [ITEM_RETRO_MAIL] = ITEM_TYPE_MAIL,
        ...
        [UNUSED_ITEM_0] = ITEM_TYPE_NONE,
        [UNUSED_ITEM_1] = ITEM_TYPE_NONE,
        [UNUSED_ITEM_2] = ITEM_TYPE_NONE,
        [UNUSED_ITEM_3] = ITEM_TYPE_NONE,
        [UNUSED_ITEM_4] = ITEM_TYPE_NONE,
        [UNUSED_ITEM_5] = ITEM_TYPE_NONE,
        [UNUSED_ITEM_6] = ITEM_TYPE_NONE,
        [UNUSED_ITEM_7] = ITEM_TYPE_NONE,
        [UNUSED_ITEM_8] = ITEM_TYPE_NONE,
        [UNUSED_ITEM_9] = ITEM_TYPE_NONE,
        [UNUSED_ITEM_10] = ITEM_TYPE_NONE,
        [ITEM_POWER_GLOVE] = ITEM_TYPE_FIELD_USE,
        [ITEM_LANTERN] = ITEM_TYPE_FIELD_USE,
        [ITEM_DIVING_SUIT] = ITEM_TYPE_FIELD_USE,
        [ITEM_BIG_ASS_HAMMER] = ITEM_TYPE_FIELD_USE,
        [ITEM_AXE] = ITEM_TYPE_FIELD_USE,
        [ITEM_SURFBOARD] = ITEM_TYPE_FIELD_USE,
