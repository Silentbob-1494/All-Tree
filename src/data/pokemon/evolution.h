const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_LEVEL, 40, SPECIES_RAICHU_ALOLAN}},
    ...
    [SPECIES_KADABRA]               = {{EVO_LEVEL, 17, SPECIES_ALAKAZAM},
                                       {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_ALAKAZAM}},
    [SPECIES_MACHOP]                = {{EVO_LEVEL, 28, SPECIES_MACHOKE}},
    [SPECIES_MACHOKE]               = {{EVO_LEVEL, 29, SPECIES_MACHAMP},
    ...
    [SPECIES_GRAVELER]              = {{EVO_LEVEL, 26, SPECIES_GOLEM},
    ...
    [SPECIES_HAUNTER]               = {{EVO_LEVEL, 26, SPECIES_GENGAR},
    ...
    [SPECIES_MIME_JR]               = {{EVO_MOVE, MOVE_MIMIC, SPECIES_MR_MIME},
                                       {EVO_LEVEL, 30, SPECIES_MR_MIME_GALARIAN}},
    ...
    [SPECIES_BOLDORE]               = {{EVO_LEVEL, 26, SPECIES_GIGALITH},
    ...
    [SPECIES_GURDURR]               = {{EVO_LEVEL, 26, SPECIES_CONKELDURR},
    ...
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 54, SPECIES_BRAVIARY},
                                       {EVO_LEVEL, 25, SPECIES_BRAVIARY_HISUIAN}},
    ...
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_LEVEL, 26, SPECIES_GOLEM_ALOLAN},
...
#endif
#if P_GEN_7_POKEMON == TRUE
    [SPECIES_ROCKRUFF_OWN_TEMPO]    = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_LYCANROC_DUSK}},
#endif
#if P_GEN_8_POKEMON == TRUE
